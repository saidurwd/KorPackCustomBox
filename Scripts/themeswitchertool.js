...
$.fn.themeswitcher = function(settings) {
    ...
    switcherpane.find('a').click(function() {
        // alert('click');
        var cookiName = options.cookieName;
        //var v = $.cookie(options.cookieName, themeName);
        //alert('cookiename' + cookiName);
        ...
        //alert('name-' + options.cookieName + "themeName" + themeName);
