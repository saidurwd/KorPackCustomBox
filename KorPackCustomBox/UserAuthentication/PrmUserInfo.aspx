                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="grdEmpInfo" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="grdEmpInfo_RowCancelingEdit"
                                ...
                                CssClass="gridview display table table-striped table-bordered table-responsive" AlternatingRowStyle-CssClass="gridviewaltrow" OnRowDataBound="grdEmpInfo_RowDataBound">
                                <Columns>
