    ...
    <div class="container">
        <div class="row">
            <div style="text-align: right; width: 100%">
                <a id="A1" class="thickbox specialLink btn btn-primary" href="NewUser.aspx?TB_iframe=true&height=480&width=700&modal=true">Create New User</a>
            </div>
        </div>
    </div>
    <div class="container">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="grdEmpInfo" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="grdEmpInfo_RowCancelingEdit"
                        ...
                        CssClass="gridview display table table-striped table-bordered" AlternatingRowStyle-CssClass="gridviewaltrow" OnRowDataBound="grdEmpInfo_RowDataBound"
                        Width="100%">
                        <Columns>
