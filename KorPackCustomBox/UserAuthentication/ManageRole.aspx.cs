...
public partial class UA_ManageRole : System.Web.UI.Page
{
    ...
    protected void mSave()
    {
        ...
        InsertTBPrmUserRole objDML = new InsertTBPrmUserRole(connection);
        try
        {
            

            objDML.RoleDesc = this.txtDescription.Text;
            objDML.COMPANY_ID = strCompanyID;
            objDML.CreatedBy =SqlInt32.Parse(Session["UserID"].ToString());
            objDML.RoleID = 0;
    ...
    protected void mUpdate()
    {
        ...
        SqlConnection connection = new SqlConnection(cnnString);
        UpdateTBPrmUserRole objDML = new UpdateTBPrmUserRole(connection);
        try
        {
            objDML.RoleID = Int32.Parse(this.HidCID.Value.ToString());
            objDML.RoleDesc = this.txtDescription.Text;
            objDML.COMPANY_ID = strCompanyID;
            objDML.CreatedBy = SqlInt32.Parse(Session["UserID"].ToString());
            objDML.Connection.Open();
    ...
    protected void cmdDelete_Click(object sender, EventArgs e)
    {
        ...
        strSQL = @"SELECT COUNT(RoleID) CVAL FROM TB_PrmUserInfo WHERE RoleID IN (" + completeString + ")";
        ...
        strSQL = @"DELETE FROM [dbo].[TB_PrmUserRole] WHERE RoleID IN (" + completeString + "); ";
        object obj = null;
