...
public partial class UserAuthentication_PrmUserFunction : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        strSelectedID = strSelectedID + this.ddlModule.SelectedValue.ToString() + '@' + '1' + '@' + '1' + '@' + '1' + '@' + '1' + '@' + '1' + '@' + '1' + '@' + '1' + '@';

        //strSelectedID = this.ddlModule.SelectedValue.ToString() + '@' + '1' + '@' +'1' + '@' + '1' + '@' + '1' + '@' + '1' + '@' + '1' + '@' + '1' + '@';
        ...
        foreach (GridViewRow gr in grdUserFunction.Rows)
        {
            ...
            Label _lblFuncDesc = gr.FindControl("lblFuncDesc") as Label; ;
        ...
        {
            SPTBInsertRolePermission objDML = new SPTBInsertRolePermission(connection);
    ...
    protected void cboUserDesc_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            this.generateFunctionList(this.cboUserDesc.SelectedValue, this.ddlModule.SelectedItem.Text);
    ...
    protected void mloadPre(object sender, EventArgs e)
    {
        clickdtect = 2;
        if ((this.cboUserDesc.SelectedItem.Value != "0") && (this.ddlModule.SelectedItem.Value != "0"))
        {
    ...
    {
        if (this.grdUserFunction.Rows.Count > 0)
        {
            ...
            grdUserFunction.UseAccessibleHeader = true;
            grdUserFunction.HeaderRow.TableSection = TableRowSection.TableHeader;
