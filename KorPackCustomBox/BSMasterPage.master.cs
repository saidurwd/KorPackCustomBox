...
public partial class MasterPage : System.Web.UI.MasterPage
{
    ...
    public void GetTask()
    {
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                hlnkInbox.Text = "<asp:HyperLink id='An' class='thickbox' NavigateUrl='http://localhost/blumensoft/Alerts.aspx?TB_iframe=true&height=480&width=700'>Inbox (<span style='color:Red'>" + dt.Rows[0][0].ToString() + "</span>)></asp:HyperLink>"; 
    ...
    protected string GetTask1()
    {
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                //strReValue="<img border='0' alt='logo' src='<%=ResolveUrl('~/images/mgs.PNG') %>' />";
                strReValue = "<a id='An' class='thickbox' href='http://localhost/blumensoft/Alerts.aspx?TB_iframe=true&height=480&width=700'></a>";
                //hlnkInbox.Text = "<a id='An' class='thickbox' href='http://localhost/blumensoft/Alerts.aspx?TB_iframe=true&height=480&width=700'>Inbox (<span style='color:Red'>" + dt.Rows[0][0].ToString() + "</span>)</a>"; 
                //hlnkInbox.Text = "<asp:HyperLink id='An' class='thickbox' NavigateUrl='http://localhost/blumensoft/Alerts.aspx?TB_iframe=true&height=480&width=700'>Inbox (<span style='color:Red'>" + dt.Rows[0][0].ToString() + "</span>)></asp:HyperLink>";
    ...
    void RenderMenuItem(string title, string address, StringBuilder output)
    {
        ...
        output.AppendFormat("><span>{0}</span></a></li><span style='font-size:24px'>•</span>", title);
    }
