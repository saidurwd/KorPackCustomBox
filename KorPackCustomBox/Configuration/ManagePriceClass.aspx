<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ManagePriceClass.aspx.cs" Inherits="UA_ManageRole" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="tabsMain" style="height: 400px">
        <ul>
            <li><a href="#tabs-1">Manage Price Class</a></li>
        </ul>
        <div id="tabs-1">
            <div class="configurationPage">
                ...
                <asp:Panel ID="Panel2" CssClass="gridPanelSalary" runat="server" Width="99%" Height="230px" ScrollBars="Auto">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="gridview"
                        AlternatingRowStyle-CssClass="gridviewaltrow" Width="100%" DataKeyNames="PCAutoId"
                        AllowSorting="true" DataSourceID="SqlDataSource1">
                        <Columns>
                            <asp:TemplateField HeaderText="Select" ControlStyle-Width="5%">
                                <ItemTemplate>
                                    <asp:CheckBox runat="server" ID="chkRow" />
                                    <asp:TextBox runat="server" ID="txtKeyField" Text='<%#Eval("PCAutoId") %>' Style="display: none" />
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Price Class" SortExpression="PriceClassDesc">
                                <ItemTemplate>
                                    <a href="javaScript:refreshParent('<%#Eval("PCAutoId") %>','<%#Eval("PriceClassDesc") %>');">
                                        <%# Eval("PriceClassDesc")%>
                                    </a>
                                </ItemTemplate>
                ...
                <div class="hiddenFields">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Cnn %>"
                        SelectCommand="SELECT     PCAutoId, PriceClassDesc
                    FROM         [dbo].[CB_PriceClass]
                    order by PriceClassDesc">
                    </asp:SqlDataSource>
                </div>
            </div>
        </div>
