...
public partial class UA_ManageRole : System.Web.UI.Page
{
    ...
    protected void mSave()
    {
        ...
        InsertCBSalesPerson objDML = new InsertCBSalesPerson(connection);
        try
        {
            objDML.SPName = this.txtName.Text;
            objDML.SPPosition = txtPosition.Text;
            objDML.SPEmail =txtEmail.Text;
            objDML.SPPhoneNo = txtPhone.Text;
            objDML.SPAddress = "";
            objDML.SPFaxNo = "";
            objDML.Comments = "";
    ...
    protected void mUpdate()
    {
        ...
        SqlConnection connection = new SqlConnection(cnnString);
        UpdateCBSalesPerson objDML = new UpdateCBSalesPerson(connection);
        try
        {
            objDML.SPAutoId = Int32.Parse(this.HidCID.Value.ToString());
            objDML.SPName = this.txtName.Text;
            objDML.SPPosition = txtPosition.Text;
            objDML.SPEmail = txtEmail.Text;
            objDML.SPPhoneNo = txtPhone.Text;
    ...
    protected void cmdDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            myScript = "showInfo('Please select a Sales Person to delete.');";
            ScriptManager.RegisterStartupScript(Page, this.GetType(), "ClientScript", myScript, true);
            myScript = "";
            return;
        }
        ...
        strSQL = @"SELECT COUNT(SPAutoId) CVAL FROM CB_Customers WHERE SPAutoId IN (" + completeString + ")";
        ...
        strSQL = @"DELETE FROM [dbo].[CB_SalesPerson] WHERE SPAutoId IN (" + completeString + "); ";
        object obj = null;
