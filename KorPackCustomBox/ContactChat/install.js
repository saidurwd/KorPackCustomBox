    ...
    myHub.client.adminResult = function (state, data) {
        if (state) {
            ...
            $('#login-alerts').html('<div class="alert alert-error">' +
                '<button type="button" class="close" data-dismiss="alert">×</button>' +
                '<strong>Oops!</strong> This is not the right password. If you do not remember your admin password, simply remove the ContactChat.dat file on your App_Data folder.</div>');
        }
    };
