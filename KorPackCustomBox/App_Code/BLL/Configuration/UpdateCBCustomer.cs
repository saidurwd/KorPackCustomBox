...
{
    #region usp_UpdateCB_Customer Wrapper
    /// <summary>
    /// This class is a wrapper for the usp_UpdateCB_Customer stored procedure.
    /// </summary>
    public class UpdateCBCustomer
    {
        ...
        public UpdateCBCustomer()
        {
        }

        public UpdateCBCustomer(string connectionString)
        {
            this.ConnectionString = connectionString;
        }

        public UpdateCBCustomer(SqlConnection connection)
        {
            this.Connection = connection;
        }

        public UpdateCBCustomer(SqlConnection connection, SqlTransaction transaction)
        {
            this.Connection = connection;
        ...
        /// <summary>
        /// The connection string to use when executing the usp_UpdateCB_Customer stored procedure.
        /// </summary>
        ...
        /// <summary>
        /// The connection to use when executing the usp_UpdateCB_Customer stored procedure.
        ...
        /// <summary>
        /// The transaction to use when executing the usp_UpdateCB_Customer stored procedure.
        ...
        /// <summary>
        /// Gets the return value from the usp_UpdateCB_Customer stored procedure.
        /// </summary>
        ...
        /// <summary>
        /// Gets the number of rows changed, inserted, or deleted by execution of the usp_UpdateCB_Customer stored procedure.
        /// </summary>
        ...
        /// <summary>
        /// This method calls the usp_UpdateCB_Customer stored procedure.
        /// </summary>
        public virtual void Execute()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "[dbo].[usp_UpdateCB_Customer]";
                ...
                SqlParameter prmCustomersId = cmd.Parameters.Add("@CustomersId", SqlDbType.Int);
                prmCustomersId.Direction = ParameterDirection.Input;
                if (CustomersId.HasValue)
                    prmCustomersId.Value = CustomersId.Value;
                else
                    prmCustomersId.Value = DBNull.Value;
        ...
        {
            UpdateCBCustomer updateCBCustomer = new UpdateCBCustomer();

            #region Assign Property Values
            updateCBCustomer.ConnectionString = connectionString;
            updateCBCustomer.CustomersId = customersId;
            updateCBCustomer.CustomersCId = customersCId;
            updateCBCustomer.CustomersDesc = customersDesc;
            updateCBCustomer.Amount = amount;
            updateCBCustomer.SPAutoId = sPAutoId;
            updateCBCustomer.PCAutoId = pCAutoId;
            updateCBCustomer.Terms = terms;
            #endregion

            updateCBCustomer.Execute();
