                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Email">
                            ...
                            <EditItemTemplate>
                                ...
                                <asp:TextBox ID="txtGrdEditEmail" runat="server" Text='<%# Bind("Email") %>'
                        ...
                        <asp:TemplateField HeaderText="For Customer">
                            ...
                            <EditItemTemplate>
                                <asp:DropDownList ID="ddlGrdEditCustomer" runat="server" DataSourceID="SqlDataSource2" DataTextField="CustomersCId"
                                    DataValueField="CustomersId" Width="98%" SelectedValue='<%# Bind("CustomerId") %>'>
                                </asp:DropDownList>
                            </EditItemTemplate>
                            <ItemStyle Width="15%" HorizontalAlign="Left" />
                            <HeaderStyle Width="15%" HorizontalAlign="Left" />
                        ...
                        <asp:TemplateField HeaderText="Login Info">
                            ...
                            <EditItemTemplate>
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td width="30%" bgcolor="silver" align="left">Password</td>
                                        <td width="70%" align="left">
