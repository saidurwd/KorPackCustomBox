...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="tabsMain" style="height: 600px">
        <ul>
            <li><a href="#tabs-1">Manage Customer</a></li>
        </ul>
        <div id="tabs-1">
            <div class="configurationPage">
                <table class="cssTableTwo">
                    ...
                    <tr>
                        <td class="style1">Sales Person:
                        </td>
                        <td class="style2" style="padding-bottom: 2px;">
                            <asp:DropDownList ID="ddlSalesPerson" runat="server" DataSourceID="SqlDataSource2" Width="93%"
                                DataTextField="SPName" DataValueField="SPAutoId">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td class="style1">Price Class:
                        </td>
                        <td class="style2" style="padding-bottom: 2px;">
                            <asp:DropDownList ID="ddlPriceClass" runat="server" DataSourceID="SqlDataSource3" Width="93%"
                                DataTextField="PriceClassDesc" DataValueField="PCAutoId">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td class="style1">Terms:
                        </td>
                        <td class="style2" style="padding-bottom: 2px;">
                ...
                <br />
                <asp:Panel ID="Panel2" CssClass="gridPanelSalary" runat="server" Width="99%" Height="150px" ScrollBars="Auto">
