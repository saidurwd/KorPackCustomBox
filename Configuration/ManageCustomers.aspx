                        ...
                        <tr>
                            ...
                            <td class="style2" style="padding-bottom: 2px;">
                                <asp:DropDownList ID="ddlSalesPerson" runat="server" DataSourceID="SqlDataSource2"
                                    Width="93%" DataTextField="SPName" DataValueField="SPAutoId">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="style2" style="padding-bottom: 2px;">
                                <asp:DropDownList ID="ddlPriceClass" runat="server" DataSourceID="SqlDataSource3"
                                    Width="93%" DataTextField="PriceClassDesc" DataValueField="PCAutoId">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
