                ...
                <div class="bs-callout bs-callout-info">
                    ...
                    <div class="row">
                        <div class="col-md-12" style="text-align: center">
                            <img src="../Images/box/1.png" id="1" alt="RSC" width="100" onclick="reply_click(this.id, this.title)" title="RSC" />
                            <img src="../Images/box/2.png" id="2" alt="BKF" width="100" onclick="reply_click(this.id, this.title)" title="Bookfold" />
                            <img src="../Images/box/4.png" id="4" alt="FOL" width="100" onclick="reply_click(this.id, this.title)" title="FOL" />
                            <img src="../Images/box/5.png" id="5" alt="HSC" width="100" onclick="reply_click(this.id, this.title)" title="HSC" />
                            <img src="../Images/box/3.png" id="3" alt="Pad" width="100" onclick="reply_click(this.id, this.title)" title="Pad/Scored Pad" />
                            <img src="../Images/box/10.png" id="10" alt="5PF" width="100" onclick="reply_click(this.id, this.title)" title="5 Panel Folder" />
                            <img src="../Images/box/7.png" id="7" alt="Tele Top" width="100" onclick="reply_click(this.id, this.title)" title="Tele Tray Set" />
                ...
                <div class="bs-callout bs-callout-danger">
                    <h4>Inside Dimensions</h4>
                     <div class="row" runat="server" id="rwPriceClass">
                        <div class="col-md-2 text-right">Price Class: </div>
                        <div class="col-md-2">
                            <asp:DropDownList ID="ddlPriceClass" runat="server" CssClass="form-control input-sm" onchange="javaScript:bindOnKeyUp1()">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <asp:DropDownList ID="ddlStyle" runat="server" CssClass="form-control input-sm" onchange="javaScript:bindOnKeyUp1()" Style="display: none">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlBroadGrade" runat="server" CssClass="form-control input-sm" onchange="javaScript:bindOnKeyUp1()">
                                    <asp:ListItem Text="1" Value="1"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                    ...
                    <div class="row" id="divBkf" style="display:none">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlPerforated" runat="server" CssClass="form-control input-sm" onchange="javaScript:bindOnKeyUp1()">
                                    <asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="No" Value="0" Selected="True"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="BoardGrade">Tuck</label>
            ...
            <div class="col-md-3">
                <div class="row">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <asp:Button ID="Button4" runat="server" Text="Email My Quote"
