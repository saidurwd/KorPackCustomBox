...
$(function () {
    ...
    myHub.client.loginResult = function (status, id, name) {
        if (status) {
            ...
            var msg = id == 'config' ?
                'No configuration file found. Please configure ContactChat before using it' :
...
function getCommands() {
    var cmdKey = getStoredCommands('ContactChat-cmd');
...
function setCommands(commands) {
    setStoredCommands('ContactChat-cmd', JSON.stringify(commands), 365);
}
