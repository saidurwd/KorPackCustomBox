...
namespace Blumen
{
    #region usp_DashboardPermission Wrapper
    /// <summary>
    /// This class is a wrapper for the usp_DashboardPermission stored procedure.
    /// </summary>
    public class DashboardPermission
    {
        ...
        public DashboardPermission(string connectionString)
        {
            this.ConnectionString = connectionString;
        }

        public DashboardPermission(SqlConnection connection)
        {
            this.Connection = connection;
        }

        public DashboardPermission(SqlConnection connection, SqlTransaction transaction)
        {
            this.Connection = connection;
        ...
        /// <summary>
        /// The connection string to use when executing the usp_DashboardPermission stored procedure.
        /// </summary>
        ...
        /// <summary>
        /// The connection to use when executing the usp_DashboardPermission stored procedure.
        ...
        /// <summary>
        /// The transaction to use when executing the usp_DashboardPermission stored procedure.
        ...
        /// <summary>
        /// Gets the return value from the usp_DashboardPermission stored procedure.
        /// </summary>
        ...
        /// <summary>
        /// Gets the number of rows changed, inserted, or deleted by execution of the usp_DashboardPermission stored procedure.
        /// </summary>
        ...
        /// <summary>
        /// This method calls the usp_DashboardPermission stored procedure.
        /// </summary>
        public virtual void Execute()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "[dbo].[usp_DashboardPermission]";
...
string connectionString,
...
)
        {
            ...
            DashboardPermission.ConnectionString = connectionString;
            DashboardPermission.CreatedBy = createdBy;
            DashboardPermission.UserID = userID;
            DashboardPermission.SplitterRow = splitterRow;
            DashboardPermission.SplitterCell = splitterCell;
            DashboardPermission.strDItemID = strDItemID;
            DashboardPermission.COMPANY_ID = cOMPANY_ID;
            #endregion

            DashboardPermission.Execute();
