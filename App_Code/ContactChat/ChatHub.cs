...
namespace Live.ContactChat
{
    ...
    {
        private const string ConfigFile = "LiveChat.dat";
        /*
        List<Agent> Agents
        {
            get
            {
                if (HttpContext.Current.Cache["ContactChat_agents"] != null)
                    return (List<Agent>)HttpContext.Current.Cache["ContactChat_agents"];
                else
                {
        ...
        */
        ...
        public void SendEmail(string from, string message)
        {
            ...
            if (config != null && config.Length >= 3)
            {
                ...
                msg.Subject = "ContactChat - Offline Contact";
                msg.Body = "You received an offline contact from your ContactChat chat widget.\r\n\r\n" + message;
        ...
        private string[] GetConfig()
        {
            ...
            {
                configPath = HttpContext.Current.Server.MapPath("~/App_Data/" + ConfigFile);
            }
